...
<%@page import="com.model.Addpayment"%>
...
try{
	...
	al = (List) session.getAttribute("booksPayList");
	for(Addpayment records : al) {
		out.println(records.getBookno() + "<br/>");
		out.println(records.getNic() + "<br/>");
		%><a href = "addPayment?id=<%=records.getId()%>&diff=<%=records.getDiff()%>">Book Returned</a><br/><%
	}
}
catch(Exception e){
...
%>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="links.jsp">My Profile</a></li>
